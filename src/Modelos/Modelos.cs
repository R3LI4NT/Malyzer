...
public class ResultadoAnalisisEstatico
{
    ...
    public FirmaDigitalInfo? FirmaDigital { get; set; }
...
public class ConfiguracionGeneral
{
    ...
    public string ClaveMalwareBazaar { get; set; } = string.Empty;
...
public class FirmaDigitalInfo
{
    ...
    public bool AutoFirmado { get; set; }
    public bool Vencido { get; set; }
    public bool CadenaConfianzaValida { get; set; }
...
public class RichHeaderInfo
{
    ...
    public List<RichHeaderEntrada> Entradas { get; set; } = new();
    public string CompiladorEstimado { get; set; } = string.Empty;
}

public class RichHeaderEntrada
{
...
public class DeteccionAv
{
    public string Motor { get; set; } = string.Empty;        // ej: "Kaspersky", "Microsoft", "Sophos"
    public string Categoria { get; set; } = string.Empty;     // "malicious", "suspicious", "harmless", "undetected", "type-unsupported", "timeout"
    public string Resultado { get; set; } = string.Empty;     // ej: "Trojan.Generic.Win32" o "" si limpio
    public string VersionMotor { get; set; } = string.Empty;
    public string FechaActualizacion { get; set; } = string.Empty;
}

public class ResultadoSubidaMuestra
{
    public bool Exito { get; set; }
    public string Servicio { get; set; } = string.Empty; // "VirusTotal" | "MalwareBazaar"
    public string Estado { get; set; } = string.Empty;   // "subida", "ya_existente", "en_analisis", "completado", "error"
    public string Mensaje { get; set; } = string.Empty;
    public string IdAnalisis { get; set; } = string.Empty;
    public string UrlReporte { get; set; } = string.Empty;
    public string HashSha256 { get; set; } = string.Empty;
    public int? DeteccionesMaliciosas { get; set; }
    public int? DeteccionesTotales { get; set; }
    public List<string> NombresFamilia { get; set; } = new();
    public DateTime Marca { get; set; } = DateTime.Now;
    /// <summary>v1.1 — desglose por motor antivirus. Solo poblado para VirusTotal.</summary>
    public List<DeteccionAv> DeteccionesPorAv { get; set; } = new();
}
